...
import com.eugene_andrienko.telegram.impl.TelegramCleanerProvider;
...
public final class Client implements AutoCloseable
{
    ...
    public interface ResultHandler
    {
         ...
         */
        void onResult(TdApi.Object object) throws ExecutionException, InterruptedException;
    }
    ...
    /**
     * Synchronously executes a TDLib request. Only a few marked accordingly requests can be
     ...
     * @param updateExceptionHandler  Handler for exceptions thrown from updateHandler. If it is
     *                                null, exceptions will be iggnored.
     * @param defaultExceptionHandler Default handler for exceptions thrown from all ResultHandler.
     *                                If it is null, exceptions will be iggnored.
     *
     * @return created Client
     */
    public static Client create(ResultHandler updateHandler,
            ExceptionHandler updateExceptionHandler, ExceptionHandler defaultExceptionHandler)
    {
    ...
    private static class ResponseReceiver implements Runnable
    {
        ...
        public void run()
        {
            ...
            while(true)
            {
                int resultN = nativeClientReceive(clientIds, eventIds, events,
                        100.0 /*seconds*/);
        ...
        private void processResult(int clientId, long id,
                TdApi.Object object)
        {
            boolean isClosed = false;
            if(id == 0 &&
               object instanceof TdApi.UpdateAuthorizationState)
            {
    ...
    {
        cleanable = TelegramCleanerProvider.getCleaner().register(this, cleanClientAction());
    ...
    private Runnable cleanClientAction()
    {
        return () -> send(new TdApi.Close(), null, null);
    }

    private static native int createNativeClient();

    private static native void nativeClientSend(int nativeClientId, long eventId,
            TdApi.Function function);

    private static native int nativeClientReceive(int[] clientIds, long[] eventIds,
